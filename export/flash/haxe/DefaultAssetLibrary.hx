...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/1248660.original.png", __ASSET__assets_images_1248660_original_png);
		type.set ("assets/images/1248660.original.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/images-go-here.txt", __ASSET__assets_images_images_go_here_txt);
		type.set ("assets/images/images-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		className.set ("assets/images/poopman.png", __ASSET__assets_images_poopman_png);
		...
		addExternal("assets/images/1248660.original.png", "image", "assets/images/1248660.original.png");
		addExternal("assets/images/images-go-here.txt", "text", "assets/images/images-go-here.txt");
		addExternal("assets/images/poopman.png", "image", "assets/images/poopman.png");
...
@:keep class __ASSET__assets_images_1248660_original_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray { }
@:keep class __ASSET__assets_images_poopman_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/1248660.original.png") class __ASSET__assets_images_1248660_original_png extends flash.display.BitmapData {}
@:file("assets/images/images-go-here.txt") class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray {}
@:bitmap("assets/images/poopman.png") class __ASSET__assets_images_poopman_png extends flash.display.BitmapData {}
